...
class SAM2EndpointTestCase(unittest.TestCase):
    """Test cases for the prompted_segmentation endpoint."""
    ...
    def test_segment_without_prompts(self):
        """Test prompted_segmentation without any prompts."""
        ...
        self.assertIn("segmentation_result", data)  # Ensure prompted_segmentation output exists

    def test_segment_with_valid_prompts(self):
        """Test prompted_segmentation with valid prompts."""
        request_data = {
            "use_prompts": True,
        ...
        self.assertIn("quality", data)  # Ensure prompted_segmentation output is present

    def test_segment_with_invalid_prompts(self):
        """Test prompted_segmentation with invalid prompts (out of bounds)."""
        invalid_data = {
            "use_prompts": True,
